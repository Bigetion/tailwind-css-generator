...
function generateAndInject(plugins, options = {}) {
...
var flexbox = {
  key: "flexbox",
  generate(config) {
    return generator24(config) + generator25(config) + generator26(config) + generator27(config) + generator28(config) + generator29(config) + generator30(config) + generator31(config) + generator32(config) + generator33(config) + generator34(config) + generator35(config) + generator36(config);
  }
};
...
var sizing = {
  key: "sizing",
  generate(config) {
    return generator37(config) + generator38(config) + generator39(config) + generator40(config) + generator41(config) + generator42(config) + generator43(config) + generator44(config);
  }
};
